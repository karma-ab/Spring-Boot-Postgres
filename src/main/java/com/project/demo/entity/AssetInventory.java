...
public class AssetInventory {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AssetInventory other = (AssetInventory) obj;
		if (action == null) {
	...
	public String toString() {
		return "AssetInventory [id=" + id + ", assetName=" + assetName + ", assetPrice=" + assetPrice + ", eligibility="
				+ eligibility + ", ratioCheck=" + ratioCheck + ", capCheck=" + capCheck + ", action=" + action + "]";
	}

	public AssetInventory(Long id, String assetName, long assetPrice, String eligibility, String ratioCheck,
			String capCheck, String action) {
		super();
		this.id = id;
		this.assetName = assetName;
		this.assetPrice = assetPrice;
